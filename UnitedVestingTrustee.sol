...
/// @title Vesting trustee contract for UnitedCrowd token.
contract UnitedVestingTrustee is Claimable {
    ...
    /// @dev Constructor that initializes the address of the SmartToken contract.
    ...
    function revoke(address _holder) public onlyOwner {
        ...
        // Send the remaining UCT back to the owner.
