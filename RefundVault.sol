...
contract RefundVault is Claimable {
    ...
    // Refund time frame
    uint256 public constant REFUND_TIME_FRAME = 14 days;
    ...
    function RefundVault(address _etherWallet, UnitedSmartToken _token) public {
    ...
    //@dev Refund ether back to the investor in returns of proportional amount of UCT
    //back to the United`s wallet
